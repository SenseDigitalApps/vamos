                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) => WebView(
                                auth: true,
                                url: '${ServerConfig().url}/form?tienda=${int.parse(widget.product.id)}&nombre=${widget.product.name}',
                                title: 'Bebida',
                              ),
                            ),
                          );
                        },
                        child: const Text('Vamos por una bebida'),
                      ):
                      TextButton(
                        style: TextButton.styleFrom(
                          backgroundColor: Theme.of(context).primaryColor,
                        ...
                        child: const Text('Vamos por una bebita'),
                      ),
                      ProductRelated(
                        product: widget.product,
                      ),
